...
- generated: 2026-08-14 23:27:09 UTC by `eval_ensemble_v2.py` v1.0.0
...
|---|---|---|
| unsafe recall R = r_H*b_H | 0.9812 | [0.946, 0.994] |
| benign FPR = r_B*b_B | 0.0202 | [0.006, 0.071] |
| precision (val pi=0.62!) | 0.9874 |  |
| F1 | 0.9843 |  |
...
| b_B = P(block|benign,fired) | 0.0556 |  |
| confusion (tp/fp/fn/tn) | 157/2/3/97 |  |
...
Measured stage rates on validation: r_H=0.9812 [0.946, 0.994], r_B=0.3636 [0.276, 0.462], b_H=1.0000, b_B=0.0556.
...
|---|---|---|---|---|---|---|
| 0.001 | 0.3643 | 0.6357 | 0.0464 | 0.3644 | 0.3653 | 0.3743 |
| 0.01 | 0.3698 | 0.6302 | 0.3291 | 0.3699 | 0.3708 | 0.3798 |
| 0.05 | 0.3945 | 0.6055 | 0.7188 | 0.3946 | 0.3955 | 0.4045 |
| 0.2 | 0.4872 | 0.5128 | 0.9239 | 0.4873 | 0.4882 | 0.4972 |
...
## Test (one-shot, locked config)

| metric (test) | value |
|---|---|
| unsafe recall | 0.9606 |
| benign FPR | 0.1100 |
| precision | 0.9173 |
| F1 | 0.9385 |
| routing rate | 0.7401 |
| confusion (tp/fp/fn/tn) | 122/11/5/89 |
